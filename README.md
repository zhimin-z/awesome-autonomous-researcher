...
> A curated list of autonomous AI scientist systems that can independently conduct research, design experiments, analyze data, write papers, and generate scientific discoveries.
